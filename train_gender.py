...
net = models.resnet18(pretrained = True) #using pre-trained weights from Imagenet-22K
...
for epoch in range(num_epochs):
  ...
  # if ((epoch+1) % 5) == 0:
  model_name = './MINIJSRT_ResNet18_Gender/MINIJSRT_ResNet18_Gender_' + str(epoch + 1) + '.model'
