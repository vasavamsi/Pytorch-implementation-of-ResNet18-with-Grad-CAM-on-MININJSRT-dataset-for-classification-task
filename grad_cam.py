...
checkpoint = torch.load('./MINIJSRT_ResNet18_Direction/MINIJSRT_ResNet18_Direction_10.model', map_location=torch.device('cpu'))
...
image_path = './Directions01_RGB/test/up/41.png'
